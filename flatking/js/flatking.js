$(document).ready(function() {
	...
	$("#style-switcher li" ).click(function(e){
		e.preventDefault();
		$m = $(this);
		if($m.attr('id') == "himage" || $m.attr('id') == "nohimage" ){
			$(".himage" ).attr('href', 'css/colors/'+$m.attr('id')+'.css' );
		}
		else {
			$(".colors" ).attr('href', 'css/colors/'+$m.attr('id')+'.css' );
			var skillsColor = $(this).css('backgroundColor');
			// Reset easyPieChart
			$('.row.skills').empty().html('\
				<h1 class="text-center scrollimation fade-in in">I Got the Skills</h1>\
						...
						<div class="col-xs-6 col-sm-6 col-md-3 text-center">\
							<span class="chart easyPieChart" data-percent="70">\
						...
						<div class="col-xs-6 col-sm-6 col-md-3 text-center">\
							<span class="chart easyPieChart" data-percent="80">\
